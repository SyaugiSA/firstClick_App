        ...
        <Container>
            ...
            <Stack direction="row" spacing={59.2}>
                ...
                <Stack direction="row" spacing={3}>
                    <ThemeProvider theme={theme}>
                        <Button color="primary" variant="contained" size="large" startIcon={<ImSortNumericAsc />}>
                            ASCENDING
                        </Button>
                    </ThemeProvider>
                    <ThemeProvider theme={theme}>
                        <Button color="primary" variant="outlined" size="large" startIcon={<ImSortNumbericDesc />}>
                            DESCENDING
                        </Button>
                    </ThemeProvider>
                </Stack>
